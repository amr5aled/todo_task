import 'package:task/services/settings.dart';
...
void main() {
  group('Test theme mode provider', () {
    ...
    test('value exposed by the provider should update when the theme is changed', () async {
      await setupHive(() async {
        await Hive.openBox<String>('settings');
      });
    ...
    test('value on the settings box should be updated when the theme is changed', () async {
      await setupHive(() async {
        await Hive.openBox<String>('settings');
      });
