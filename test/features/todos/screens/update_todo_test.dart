...
import 'package:task/features/todos/screens/update_todo.dart';
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.pumpWidget(
          ProviderScope(
            overrides: [apiServiceProvider.overrideWith((ref) => createMockedApiClient())],
        ...
        await tester.tap(completed ? completedSegmentFinder : notCompletedSegmentFinder);
        ...
        await expectLater(
          ...
          completion(
            allOf(
              ...
              isA<Todo>().having((item) => item.userId, 'userId', equals(userId)),
              isA<Todo>().having((item) => item.completed, 'completed', completed),
            ),
          ),
        );
      },
