  ...
  group('Test TodoScreen details', () {
    testWidgets(
      ...
      (tester) async {
        ...
        final statusFinder = find.text(todo.completed ? 'Completed' : 'Not completed');
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await expectLater(
          ...
          completion(
            isNot(contains(isA<Todo>().having((item) => item.id, 'id', equals(id)))),
          ),
        );
      },
    );
                  ...
                  routes: [
                    GoRoute(
                      ...
                      routes: [
                        GoRoute(
                          path: 'update',
                          builder: (_, __) => SizedBox(key: updateTodoScreenKey),
                        ),
                      ],
                    ),
                  ],
