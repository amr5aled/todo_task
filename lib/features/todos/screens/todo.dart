  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: todo.when(
        ...
        data: (todo) {
          final records = [
            ...
            (label: 'Status', text: todo.completed ? 'Completed' : 'Not completed'),
          ];
      ...
      floatingActionButton: FloatingActionButton(
        // context.go('/todos/$id/update'),
        onPressed: () =>
            Navigator.push(context, MaterialPageRoute(builder: (_) => UpdateTodoScreen(id))),
        tooltip: 'Edit',
